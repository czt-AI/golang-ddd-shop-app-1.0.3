...
type ProductService interface {
	CreateProduct(ctx context.Context, name, description string, price decimal.Decimal, stock int, categoryId int, images []string) (*domain.Product, error)
	...
	ListProductsByCategory(ctx context.Context, categoryId int) ([]domain.Product, error)
}
...
func (s *ProductServiceImpl) CreateProduct(ctx context.Context, name, description string, price decimal.Decimal, stock int, categoryId int, images []string) (*domain.Product, error) {
...
func (s *ProductServiceImpl) GetProduct(ctx context.Context, productId int) (*domain.Product, error) {
...
func (s *ProductServiceImpl) ListProductsByCategory(ctx context.Context, categoryId int) ([]domain.Product, error) {
