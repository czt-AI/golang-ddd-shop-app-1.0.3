...
type ShippingService interface {
	CreateShipping(ctx context.Context, orderId uuid.UUID, logisticsCompany, trackingNumber string, estimatedDelivery time.Time) (*domain.Shipping, error)
	GetShipping(ctx context.Context, shippingId uuid.UUID) (*domain.Shipping, error)
	...
	ListShipments(ctx context.Context, orderId uuid.UUID) ([]domain.Shipping, error)
}
...
func (s *ShippingServiceImpl) CreateShipping(ctx context.Context, orderId uuid.UUID, logisticsCompany, trackingNumber string, estimatedDelivery time.Time) (*domain.Shipping, error) {
...
func (s *ShippingServiceImpl) GetShipping(ctx context.Context, shippingId uuid.UUID) (*domain.Shipping, error) {
...
func (s *ShippingServiceImpl) ListShipments(ctx context.Context, orderId uuid.UUID) ([]domain.Shipping, error) {
