...
type PaymentRepository interface {
	...
	FindById(ctx context.Context, paymentId uuid.UUID) (*Payment, error)
...
func (repo *InMemoryPaymentRepository) Save(ctx context.Context, payment *Payment) error {
	repo.payments[payment.PaymentId] = payment
	return nil
}

// FindById finds a payment by ID.
func (repo *InMemoryPaymentRepository) FindById(ctx context.Context, paymentId uuid.UUID) (*Payment, error) {
...
func (repo *InMemoryPaymentRepository) FindByOrderId(ctx context.Context, orderId uuid.UUID) (*Payment, error) {
